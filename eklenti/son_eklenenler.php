...
{
if($i==5)break;
echo "<li onmouseover=\"urun_goster('son_$s->no',1)\" onmouseout=\"urun_goster('son_$s->no',0)\">";
...
echo "<div id=son_$s->no class=eklenti-liste-urun>";
